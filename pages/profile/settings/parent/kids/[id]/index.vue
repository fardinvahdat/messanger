<template>
  <section>
    <section class="settings px-4 py-6">
      ...
      <hr class="my-2 border border border-opacity-10">
      <section class="text-center">
      <section class="flex items-center justify-center gap-3">
        <img :src="`/assets/images/avatars/avatar1.png`" class="w-16 h-16 rounded-full"/>
      </section>
        <section>
      ...
      <section class="grid grid-cols-1 gap-4">
        <section>
          <label class="font-normal text-sm text-gray-500">Max post in day</label>
          <el-input type="number" v-model="settings.maxPost" />
        </section>
        <section class="flex items-center gap-2 justify-between">
          <label class="font-normal text-sm text-gray-500">Activate</label>
          <Checkbox v-model="settings.activate"/>
        </section>
      </section>
