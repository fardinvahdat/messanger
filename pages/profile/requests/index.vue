<template>
  <section class="requests px-3 py-6">
    <section class="flex items-center gap-2">
      ...
      <h1 class="text-gray-700 font-bold text-lg">Requests</h1>
    </section>
    <hr class="my-4 border border-gray-300 border-opacity-10">
    <section class="grid grid-cols-1 gap-4">
    <Item v-for="request in requests" :key="request.id" :info="request" />
    </section>
  </section>
</template>

<script setup>
import Item from "@/components/TheProfile/Request/Item";
const router = useRouter()
const requests = ref([
  { id: 1, image: '/assets/images/avatars/avatar1.png' },
  { id: 2, image: '/assets/images/avatars/avatar2.png' },
  { id: 3, image: '/assets/images/avatars/avatar3.png' },
  { id: 4, image: '/assets/images/avatars/avatar4.png' },
])
</script>
