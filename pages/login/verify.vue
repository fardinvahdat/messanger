<template>
  <section>
    ...
    <p class="mt-7 font-normal text-lg">
      We sent an email, with Verification code to<b>mymail@domain.com</b>
      <br />
    ...
    <section class="mt-5">
      <el-button class="btn btn-primary w-full" @click="pushReset"
        >Submit</el-button
      >
    </section>
  </section>
...
const pushReset = (e) => {
  router.push({ path: "/login/reset-password" });
};
