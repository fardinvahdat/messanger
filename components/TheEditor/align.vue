...
<template>
  <div v-if="this.mSelectMode === 'multiple'" class="box attr-item">
    <!-- 水平对齐 -->
    <Tooltip :content="'group_align.left'">
    ...
    <Tooltip :content="'group_align.centerX'">
    ...
    <Tooltip :content="'group_align.right'">
    ...
    <!-- 垂直对齐 -->
    <Tooltip :content="'group_align.top'">
    ...
    <Tooltip :content="'group_align.centerY'">
    ...
    <Tooltip :content="'group_align.bottom'">
    ...
    <!-- 平均对齐 -->
    <Tooltip :content="'group_align.averageX'">
    ...
    <Tooltip :content="'group_align.averageY'">
