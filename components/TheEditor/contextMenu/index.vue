...
export default {
        ...
        // 排序
        {
          ...
          children: [
            ...
            },
            {
              type: "sort",
              activeName: "upTop",
              text: "mouseMenu.upTop",
              subText: "BringToFront",
            },
            {
              type: "sort",
              activeName: "downTop",
              text: "mouseMenu.downTop",
              subText: "SendToBack",
            },
          ],
        },
  ...
  mounted() {
    this.canvasDom = document.getElementById("canvas") || null;
    this.$nextTick(() => {
